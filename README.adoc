...
:experimental:
:url-github: https://github.com/hyperpolymath/zotero-rescript-templater
:url-gitlab: https://gitlab.com/hyperpolymath/zotero-rescript-templater
:url-bitbucket: https://bitbucket.org/hyperpolymath/zotero-rescript-templater
:url-codeberg: https://codeberg.org/hyperpolymath/zotero-rescript-templater

Zotero ReScript template generator
...
zotero-rescript-templater is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
