= RSR Compliance: zotero-rescript-templater
:toc:
:sectnums:

== Overview

This document describes the Rhodium Standard Repository (RSR) compliance status for *zotero-rescript-templater*.
...
|Primary language is Tier 1/2 |✓ |nix
